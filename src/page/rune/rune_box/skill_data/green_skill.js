export const green_skill = [
  ...
  },
  {
    ...
    rune_tag: ["攻擊", "打擊", "物理", "持續時間", "移動", "貫穿斬擊"],
  ...
  },
  {
    ...
    rune_tag: ["攻擊", "廣域", "打擊", "毒性", "投射體", "弓", "毒性箭雨"],
    rune_limit: ["無法並列發射，無法分離，無法連鎖", "可使用弓"],
    rune_rank_effect: {
  ...
  },
  {
    ...
    rune_tag: ["咒文", "防禦強化", "攻擊強化", "切換", "切換效果", "弩專家"],
    rune_limit: ["無連結限制", "可使用所有武器"],
    rune_rank_effect: {
      magic: "技能符文效果+15%",
      rare: "技能符文效果+40%",
  ...
  },
  {
    ...
    rune_tag: ["攻擊", "近距", "打擊", "物理", "投射體", "弓", "衝擊波箭矢"],
    rune_limit: ["無法分離，無法連鎖", "可使用弓"],
    rune_rank_effect: {
      magic: "N/A",
