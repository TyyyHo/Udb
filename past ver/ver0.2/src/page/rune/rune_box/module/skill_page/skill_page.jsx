    ...
    <div className="main_container">
      <div className="sub_container">
            ...
            <div className="page_skill_rank_container">
              <table>
                <tbody className="page_skill_rank">
                  ...
                  <tr>
                    <th className="legend_rune">傳說</th>
                    <td
                      dangerouslySetInnerHTML={{
        ...
        <div className="page_sub">
          <div className="page_sub_title">30等數值</div>
          <div className="page_skill_rank_container">
            <table>
              <tbody className="page_skill_rank">
                <tr>
                  <td>魔力消耗</td>
                  <td>{matched_data.rune_lv30.consume}</td>
                </tr>
                <tr>
                  <td>數值</td>
                  <td
                    dangerouslySetInnerHTML={{
                      __html: matched_data.rune_lv30.value,
                    }}
                  ></td>
                </tr>
              </tbody>
